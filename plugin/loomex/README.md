...
```bash
curl -fsSL https://github.com/loomex-app/loomex-plugin/releases/download/v0.1.43/install-codex.sh | sh
```

The `0.1.43` release includes Runner-owned provider command execution:
