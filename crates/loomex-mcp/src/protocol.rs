...
mod tests {
    ...
    #[test]
    fn workflow_builder_dispatch_contract_preserves_builder_and_agent_session_roles() {
        let text = tool_result_text(
            ...
            &success_envelope(
                ...
                json!({
                    ...
                    "validationErrors": ["start uses unsupported node type"],
                    "agentTask": {
                        "prompt": "repair",
                        "promptContract": {"sha256": "hash"},
                        "sessionDirective": {
                            "action": "resume",
                            "sessionId": "agent-1"
                        }
